...
void loop() {
  // ThingSpeak'e gönderilecek veri
  String data = "GET https://api.thingspeak.com/update?api_key=4K0AG7XND9E1C1HI&field1=0=10\r\n";

  // Veriyi ThingSpeak sunucusuna gönderin
  sendATCommand(data, 2000);
